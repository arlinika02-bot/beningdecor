<div class="main-content">
    ...
    <form method="POST" action="<?php echo base_url('admin/edit_admin') ?>">
        ...
        <div class="form-group">
            ...
            <input type="text" name="alamat" class="form-control"
                value="<?php echo set_value('alamat', $user->alamat) ?>">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="gender">
                ...
                <option value="Laki-laki" <?php echo set_select('gender', 'Laki-laki', $user->gender == 'Laki-laki') ?>>
                    Laki-laki</option>
                <option value="Perempuan" <?php echo set_select('gender', 'Perempuan', $user->gender == 'Perempuan') ?>>
                    Perempuan</option>
            </select>
        ...
        <div class="form-group">
            ...
            <input type="text" name="no_telepon" class="form-control"
                value="<?php echo set_value('no_telepon', $user->no_telepon) ?>">
