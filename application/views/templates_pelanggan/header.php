            ...
            <div class="align-self-center collapse navbar-collapse flex-fill d-lg-flex justify-content-lg-between"
                ...
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url('Home/dashboard') ?>">Home</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown"
                                ...
                                <li>
                                    <a class="dropdown-item" href="<?= base_url('auth/change_password') ?>"
                                        ...
                                        <i class="fas fa-key me-2" style="font-size: 8px;"></i>Ubah Password
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= base_url('pelanggan/profil') ?>"
                                        style="font-size: 10px; padding: 4px 8px;">
                                        <i class="fas fa-key me-2" style="font-size: 8px;"></i>Profil
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= base_url('auth/logout') ?>"
                                        style="font-size: 10px; padding: 4px 8px;">
                                        <i class="fas fa-sign-out-alt me-2" style="font-size: 8px;"></i>Logout
                                    </a>
                                </li>
                            </ul>
